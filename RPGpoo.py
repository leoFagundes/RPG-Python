                    ...
                    while True:
                        if aventureiro.bool_slot4 == True and aventureiro.bool_slot5 == True:
                            ...
                            \033[1;37mVocê deseja equipar em qual slot?
                                1 - slot 1 ({aventureiro.slot1[3]})
                                2 - slot 2 ({aventureiro.slot2[3]})
                                3 - slot 3 ({aventureiro.slot3[3]})
                                4 - slot 4 ({aventureiro.slot4[3]})
                                5 - slot 5 ({aventureiro.slot5[3]})\033[m
                            """
                            ...
                            \033[1;37mVocê deseja equipar em qual slot?
                                ...
                                2 - slot 2 ({aventureiro.slot2[3]})
                                3 - slot 3 ({aventureiro.slot3[3]})
                                5 - slot 4 ({aventureiro.slot4[3]})\033[m
                            """
                            ...
                            \033[1;37mVocê deseja equipar em qual slot?
                                1 - slot 1 ({aventureiro.slot1[3]})
                                2 - slot 2 ({aventureiro.slot2[3]})
                                3 - slot 3 ({aventureiro.slot3[3]})\033[m
                            """
                        print(texto)
                        escolha = input()
